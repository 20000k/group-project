    ...
    <div class="content-inner form-cont">
        ...
        <script type="text/html" id="toolbarDemo">
            <div class="layui-btn-container">
                <button class="layui-btn layui-btn-sm" lay-event="getCheckData">新增订单</button>
            </div>
        </script>
        ...
        <script>
            layui.use('table', function () {
                ...
                table.render({
                    ...
                    , cols: [[
                        {checkbox: true}
                        , {field: 'id', title: '订单编号', width: 110, sort: true}
                        , {field: 'pid', title: '商品编号', width: 110, sort: true, edit: 'text'}
                        , {field: 'username', title: '用户名', width: 110, sort: true, edit: 'text'}
                        , {
                            field: 'proute',
                            title: '商品图片',
                            width: 150,
                            align: 'center',
                            templet: '<div><img src="{{ d.proute}}"></div>'
                        }

                        , {field: 'commodity', title: '商品描述', edit: 'text'}
                        , {field: 'pname', title: '商品名称', width: 100, edit: 'text'}
                        , {field: 'price', title: '商品单价', width: 90, edit: 'text'}
                        , {field: 'pnumber', title: '数量', width: 80, edit: 'text'}
                        , {field: 'totalPrice', title: '总价', width: 80, edit: 'text'}
                        , {field: 'state', title: '订单状态', sort: true, width: 110, edit: 'text'}
